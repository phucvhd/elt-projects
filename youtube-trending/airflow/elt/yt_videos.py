...
def elt_trending_video():
    logger.info("Starting elt_trending_video .....")
    try:
        ...
        logger.info("Ending elt_trending_video .....")
    except Exception as e:
        logger.error(f"Error at elt_trending_video: ", e)
        exit(1)

# Extract and Load video_categories
def elt_video_categories():
    logger.info("Starting elt_video_categories .....")
    try:
        ...
        logger.info("Ending elt_video_categories .....")
    except Exception as e:
        logger.error(f"Error at elt_video_categories: ", e)
        exit(1)
